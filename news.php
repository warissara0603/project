				...
				<div class="col-lg-6 col-md-6">
					<div class="footer-box pages">
						...
						<ul>
							...
							<li><i class="fas fa-angle-right" style="padding-right: 15px;"></i><a href="about.php">ผลิตภัณฑ์</a></li>
							<li><i class="fas fa-angle-right" style="padding-right: 15px;"></i><a href="services.php">โปรโมชั่น</a></li>
