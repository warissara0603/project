        ...
        <div class="row">
          <div class="col-lg-12 col-sm-12 text-center">
            <div class="main-menu-wrap">
              ...
              <nav class="main-menu ">
                <ul >
                  <li class="current-list-item"><a href="index.html">หน้าแรก</a></li>
                  <li>
                  ...
                  <li>
                    <div class="header-icons" style="font-size: 14px; margin-left: 25px;">
                      ...
                      >
                      <a class="show-modal"data-toggle="modal" data-target="#myModalRegister"
                        ><i
          ...
          <div class="col-lg-8 offset-lg-2 text-center">
            <div class="section-title">
              ...
              <p style="  letter-spacing: 2px;">
                ช้อปสินค้าชุมชน ผลิตจากฝีมือคนแม่ฮ่องสอน : ชวนให้คุณมาซื้อสินค้าชุมชนที่มีคุณภาพ ที่ผ่าoxed-btnนการคัดเลือกมาแล้วมากกว่า 30 ร้าน <br>การันตีได้เลยว่าถูก และดีมีอยู่จริง
              </p>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4 col-md-6 text-center">
            <div class="single-product-item">
              ...
              <a href="https://shopee.co.th/hedkorleaw?utm_content=v7AhqvmwtRwAThK4mwBdnNgesBV" class="cart-btn"
                ><i class="fas fa-shopping-cart"></i> สั่งสินค้า shopee</a
              >
            </div>
          </div>
          <div class="col-lg-4 col-md-6 text-center">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-latest-news">
              ...
              <div class="news-text-box">
                <h3>
                  <a href="single-news.html"
                    >จัดกิจกรรม Live สด เกี่ยวกับสินค้าชุมชนจังหวัดแม่ฮ่องสอน พบกับ สาวมากความสามารถคุณลูกพีช เจ้าของช่อง " ลูกพีชChanel "
                    </a
                  >
                </h3>
                <p class="excerpt">
          ...
          <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
            <div class="single-latest-news">
              ...
              <div class="news-text-box">
                <h3>
                  <a href="single-news.html"
                    >เปิดเมิงไต ชิมอาหารไทใหญ่ ชมสินค้าท้องถิ่น ครั้งที่ 16 ชวน ช้อป ชิม</a
                  >
                </h3>
                <p class="excerpt">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 text-right col-md-12">
            <div class="social-icons">
              <ul>
                <li>
                  <a href="https://www.facebook.com/hedkorleawOTOP" target="_blank"
                ...
                <li>
                  <a href="https://www.tiktok.com/@hedkorleaw2?is_from_webapp=1&sender_device=pc" target="_blank"
                    ><i class="	fab fa-tumblr"></i
                  ></a>
                </li>
                <li>
                  <a href="https://shopee.co.th/hedkorleaw?utm_content=v7AhqvmwtRwAThK4mwBdnNgesBV" target="_blank"
