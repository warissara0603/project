<?php
  ...
  $sql = "UPDATE `viewcount` SET `view_count`=`view_count`+ 1 WHERE `viewid` = 1";
        ...
        <div class="col-lg-4 col-md-6 text-center">
          <div class="single-product-item">
            <div class="product-image">
              <a href="https://shopee.co.th/hedkorleaw?utm_content=v7AhqvmwtRwAThK4mwBdnNgesBV"><img src="assets/img/products/<?php echo $row['pic_product']?>" alt="" /></a>
            </div>
