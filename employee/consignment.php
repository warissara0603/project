              ...
              <table class="cart-bank" style="background-color: #f2f2f2">
                ...
                <tbody style="height: 50px">
                  <tr class="bank-body-row text-center">
                    ...
                    <td>
                      <div class="button" style="text-align: right; margin-right: 10px;">
                        <a class="correct" href="editorproduct.php?id=<?php echo $row['product_id']?>"><i class="	fas fa-pen"></i></a>
                        <a class="delete" href="CRUDemp/delete_product.php?id=<?php echo $row['product_id']?>"><i class="fas fa-trash-alt"></i></a>
                      </div>
                    </td>
                  </tr>
                </tbody>
