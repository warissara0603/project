...
<body>
	...
	<div class="latest-news mt-80 mb-150">
		<div class="container">
			<a href="addnews.php"><button class="news">เพิ่มประชาสัมพันธ์</button></a>
			<div class="row">
			<?php
				if(isset($_GET['id'])){
					$id = $_GET['id'];
					...
					<div class="single-latest-news">
						...
						<div class="news-text-box">
							...
							<div class="button" style="text-align: right;">
								<a class="correct" href="editornews.php?id=<?php echo $row['new_id']?>"><i class="	fas fa-pen"></i></a>
								<a class="delete" href="CRUDemp/delete_news.php?id=<?php echo $row['new_id']?>"><i class="fas fa-trash-alt"></i></a>
							</div>
						</div>
					</div>
				</div>
