          ...
          <div class="col-lg-8 offset-lg-2 text-center">
            <div class="section-title">
              ...
              <p style="letter-spacing: 2px">
                ...
                ที่ผ่านการคัดเลือกมาแล้วมากกว่า 30 ร้าน
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-latest-news">
              ...
              <div class="news-text-box">
                <h3>
                  <a href="single-news.php">จัดกิจกรรม Live สด เกี่ยวกับสินค้าชุมชนจังหวัดแม่ฮ่องสอน
          ...
          <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
            <div class="single-latest-news">
              ...
              <div class="news-text-box">
                <h3>
                  <a href="single-news.php">เปิดเมิงไต ชิมอาหารไทใหญ่ ชมสินค้าท้องถิ่น ครั้งที่ 16 ชวน
                    ช้อป ชิม</a>
                </h3>
                <p class="excerpt">
