        ...
        <div class="col-lg-12 col-md-6">
          <div class="single-latest-board">
            <div class="board-text-box">
              <h3 class="text-center">รายงานการขายสินค้าประจำเดือน</h3>
              <label>เดือน</label>
            ...
            <a href="../assets/PDF/hedkorleaw_report_month.pdf"><button class="boxed-btn" type="submit">ออกรายงาน</button></a>
            </div>
          </div>
        </div>
