...
<head>
  ...
  <style>
    ...
    .single-latest-board input[type="number"] {
        ...
        <div class="col-lg-12 col-md-6">
          <div class="single-latest-board">
            <div class="board-text-box">
              <h3 class="text-center">รายงานสินค้าขายดีประจำปี</h3>
              <label>ปี</label>
              <input type="number" min="2024" max="2099" step="1" value="2024" />
            </div>
            <div class="button text-center">
              <a href="../assets/PDF/hedkorleaw_report_sale_year.pdf"><button class="boxed-btn" type="submit">ออกรายงาน</button></a>
            </div>
          </div>
        </div>
